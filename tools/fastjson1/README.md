...
- [自定义序列化和反序列化](https://github.com/alibaba/fastjson/wiki/%E5%9C%A8-Spring-%E4%B8%AD%E9%9B%86%E6%88%90-Fastjson)
...
```java
    ...
    void testSerializer1() {
        ...
        String str = JSONObject.toJSONString(user,
                ...
                SerializerFeature.WriteNullNumberAsZero,   // Number -> 0
                SerializerFeature.WriteNullBooleanAsFalse, // Boolean -> false
                SerializerFeature.WriteNullListAsEmpty     // List/Set -> []
        );
