                        ...
                        items: [
                                ...
                                items: [
                                    ...
                                    {text: '使用文档（AI生成）', link: '/database/mysql/README_AI'},
                                    {
                                        ...
                                        items: [
                                            ...
                                            {text: '基础关系模型', link: '/database/mysql/modeling/basic-relation-model'},
                                            {text: '通用字典与配置模型', link: '/database/mysql/modeling/common-dictionary-and-configuration-model'},
                                            {text: '层级、分类与资源模型', link: '/database/mysql/modeling/hierarchy-category-resource-model'},
                                            {text: '用户、权限与组织模型', link: '/database/mysql/modeling/user-permission-organization-model'},
                                            {text: '商品、交易与支付模型', link: '/database/mysql/modeling/product-transaction-payment-model'},
                                            {text: '账户、库存与流水模型', link: '/database/mysql/modeling/account-inventory-ledger-model'},
                                            {text: '并发控制与防重模型', link: '/database/mysql/modeling/concurrency-control-and-duplicate-prevention-model'},
                                            {text: '扩展字段与读模型', link: '/database/mysql/modeling/extension-fields-and-read-models'},
                                            {text: '多租户与数据隔离模型', link: '/database/mysql/modeling/multi-tenant-and-data-isolation-model'},
                                            {text: '历史版本与数据变更模型', link: '/database/mysql/modeling/historical-version-and-data-change-model'},
                                            {text: '日志与审计模型', link: '/database/mysql/modeling/log-and-audit-model'},
                                            {text: '消息与事件模型', link: '/database/mysql/modeling/message-and-event-model'},
                                            {text: '统计、搜索与查询优化模型', link: '/database/mysql/modeling/statistics-search-query-optimization-model'},
                                            {text: '数据生命周期模型', link: '/database/mysql/modeling/data-lifecycle-model'},
                                            {text: '大数据量架构模型', link: '/database/mysql/modeling/large-data-volume-architecture-model'},
                                        ]
                                    },
                                ]
                            },
                            {
                                ...
                                items: [
                                    ...
                                    {text: 'PostGIS', link: '/database/postgresql/postgis'},
                                    {text: 'pgvector', link: '/database/postgresql/pgvector'},
                                ]
                            },
                        ]
                    },
