...
参考 [Mybati-Flex使用文档](/database/mybatis-flex/README.md) 完成集成数据库，最后将数据库的file_detail和file_part_detail表生成代码

#### 集成MyBatis Plus

参考 [Mybati Plus使用文档](/database/mybatis-plus/README.md) 完成集成数据库，最后将数据库的file_detail和file_part_detail表生成代码
