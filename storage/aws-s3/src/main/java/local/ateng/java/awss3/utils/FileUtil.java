...
public final class FileUtil {
     ...
     * @throws IOException 写入失败抛出异常
     */
    public static void writeMultipleFiles(java.util.Map<Path, String> contentMap) throws IOException {
        if (contentMap == null || contentMap.isEmpty()) {
            return;
        }

        for (java.util.Map.Entry<Path, String> entry : contentMap.entrySet()) {
     ...
     * @throws IOException 写入失败抛出异常
     */
    public static void appendMultipleFiles(java.util.Map<Path, String> contentMap) throws IOException {
        if (contentMap == null || contentMap.isEmpty()) {
            return;
        }
