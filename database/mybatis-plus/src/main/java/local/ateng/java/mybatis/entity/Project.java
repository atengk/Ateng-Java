...
@Setter
@ToString
@TableName(value = "project_mini", autoResultMap = false)
public class Project implements Serializable {
     ...
     * JSON对象类型数据
     */
    @TableField(value = "json_object", typeHandler = JacksonTypeHandler.class)
//    @TableField("json_object")
