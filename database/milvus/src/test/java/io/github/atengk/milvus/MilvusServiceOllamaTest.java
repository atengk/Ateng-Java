...
@SpringBootTest
public class MilvusServiceOllamaTest {

    @Autowired
    private MilvusService milvusService;
    @Autowired
    @Qualifier("ollamaEmbeddingServiceImpl")
    ...
    void testCreateCollection() {
        int dimension = 2560;
        if (embeddingService.dimension() != dimension) {
            System.err.println("embedding 维度值不一致，请检查");
            return;
        }
