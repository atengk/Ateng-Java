...
```
加密后: ENC(Rmr05VF+BmyWYaQzScKXsQ==)
解密后: root123
```
...
user:
  name: "ateng"
  password: ENC(Rmr05VF+BmyWYaQzScKXsQ==)
```
...
```
2025-09-03 09:52:45.089  INFO 47728 --- [           main] l.a.j.jasypt.runner.MyApplicationRunner  : 加密后的配置：root123
```
...
关于 `PBEWITHHMACSHA512ANDAES_256` 算法，如果使用这个算法需要JDK8以上